# 💫About Me :
.NET Developer with 9+ years of experience building robust and scalable applications using ASP.NET,MVC, API and SQL. Currently working on .Net Core and REACT
